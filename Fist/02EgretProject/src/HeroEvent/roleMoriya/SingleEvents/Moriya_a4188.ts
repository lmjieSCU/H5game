class Moriya_a4188 {
    ...
    public static instance_First: Moriya_a4188;
    public static instance_Second: Moriya_a4188;

    constructor() {
        return;
    }

    public static getInstance(owner: Role, firstCall: boolean = true): Moriya_a4188 {
    ...
    public static addEventa4188(MC: zmovie.ZMovieClip, own_role: Role) {
        let a4188 = Moriya_a4188.getInstance(own_role, false);
        if (!a4188.firstCall) {
            return;
        }
    ...
    public enterFrame(own_role: Role) {
        ...
        let a4188 = Moriya_a4188.getInstance(own_role);
        let _posObj = eval(a4188.posObj).getInstance(own_role);//opp_B
        let hit = own_role.catch_oppPos2(a4188.MC, _posObj.MC, a4188.status_1, a4188.flag, a4188.land, a4188.hurt, a4188.downHit);
        if (hit) {
