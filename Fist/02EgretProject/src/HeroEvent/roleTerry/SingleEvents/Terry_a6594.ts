class Terry_a6594 {
    ...
    public static instance_First: Terry_a6594;
    public static instance_Second: Terry_a6594;

    constructor() {
        return;
    }

    public static getInstance(owner: Role, firstCall: boolean = true): Terry_a6594 {
    ...
    public static addEventa6594(MC: zmovie.ZMovieClip, own_role: Role) {
        let a6594 = Terry_a6594.getInstance(own_role, false);
        if (!a6594.firstCall) {
            return;
        }
