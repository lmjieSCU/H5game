class TaskLayer extends Scene {
    ...
    onEnter() {
        ...
        // let taskBg: egret.Shape = new egret.Shape();
        // taskBg.graphics.beginFill(0xf0f0f0);
        // taskBg.graphics.drawRect(0, 0, UI.WINSIZE_W/4*3, UI.WINSIZE_H/4*3);
        // taskBg.graphics.endFill();

        // let taskChestBg: egret.Shape = new egret.Shape();
        // taskChestBg.graphics.beginFill(0x0f0f0f);
        // taskChestBg.graphics.drawRect(0, 0, 100, UI.WINSIZE_H/4*3);
        // taskChestBg.graphics.endFill();


        // this.taskList.addChild(taskBg);
        // this.taskChest.addChild(taskChestBg);
    ...
    public openChest(lv: number) {//开启任务宝箱
        ...
        this.chests[lv-1].$setTexture(RES.getRes("Home_treasurebox_on_png"));
        console.log(reward);
    }
