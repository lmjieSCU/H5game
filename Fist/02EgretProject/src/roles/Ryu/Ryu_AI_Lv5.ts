class Ryu_AI_Lv5 extends Ryu_AI
{
    constructor(num:number=1) {
        super();
        this.skill_init();
        this.combo_init();
        let aiGrade=RES.getRes("AI_dis_json")[`LV${num}`];
        console.log(aiGrade);
        this.combo_rate0 = aiGrade["combo_rate0"];
        this.attack_rate0 = aiGrade["attack_rate0"];
        this.hold_rate0 = aiGrade["hold_rate0"];
        this.attack_s0 = aiGrade["attack_s0"];
        this.wait_frame0 = aiGrade["wait_frame0"];
        this.combo_risk = aiGrade["combo_risk"];
        this.skill_rate0= aiGrade["skill_rate0"];
        this.strength=aiGrade["strength"];
    }
    public skill_init()
    {
        ...
        this.skill_dis[1] = ["kick", "sk2", this.skillObj.toAir, "squatKick", this.skillObj.heavyHit];
        this.skill_dis[2] = ["sk2", "jump_f", "jump_b"];
        this.skill_dis[3] = ["sk1", "sk2", "walk_f", "jump_f"];
        this.skill_dis[4] = ["sk1", "sk2", "walk_f", "dash_f", "jump_f"];
        ...
        this.skill2_dis[1] = ["kick", "sk2", this.skillObj.toAir, "squatKick"];
        this.skill2_dis[2] = ["sk2", "jump_f"];
        this.skill2_dis[3] = ["sk1", "sk2", "jump_f"];
        this.skill2_dis[4] = ["sk1", "sk2", "jump_f"];
    ...
    public combo_init()
    {
        ...
        this.combo_burst.punch2 = ["sk10", "sk14", "sk13", "sk_s_sys", "sk_s_swms", "sk_s_swms"];
        this.combo_burst.kick2 = ["sk10", "sk14", "sk13", "sk_s_sys", "sk_s_swms", "sk_s_swms"];
        this.combo_burst.sk14 = ["sk3", "sk13", "sk_s_sys"];
        this.combo_oppOnEgde.sk14 = [true, true, true];
        ...
        this.action_1.super = [["sk10", "sk13", "sk14"], ["sk10"]];
        this.delay_frames.super = [160, 300];
        this.action_1.busrt = [["sk_s_swms", "sk_s_swms", "sk_s_sys"], ["sk_s_sys"]];
        this.delay_frames.busrt = [220, 300];
    } // End of the function
} // End of Class