class Type2_K_AI_Lv5 extends Type2_K_AI
{
    ...
    public combo_init()
    {
        ...
        this.combo_1.punch2 = ["sk_dfp", "sk_dfp", "sk_dfk", "punch_s1", "kick_s2", "kick_s2", "sk_fdfp", "sk_s1_2", "sk_menghuti"];
        this.combo_1.punch_l = ["punch_l", "kick_l", "squatKick_l", "punch"];
        this.combo_1.kick = ["sk_dbk_2", "sk_dfp"];
        this.combo_1.kick2 = ["sk_dfp", "sk_dfp", "sk_dfk", "punch_s1", "kick_s2", "kick_s2", "sk_fdfp", "sk_s1_2", "sk_menghuti"];
        ...
        this.combo_burst.punch2 = ["sk_dfp", "kick_s2", "sk_s1_2", "sk_menghuti", "sk_liandong", "sk_xiangdong"];
        this.combo_burst.kick2 = ["sk_dfp", "kick_s2", "sk_s1_2", "sk_menghuti", "sk_liandong", "sk_xiangdong"];
        ...
        this.action_1.defendAttack = [["sk_fdfp", "sk_fdfp2", "sk_menghuti", "hold_u"], ["sk_s1_2", "hold_u", "hold_u"]];
