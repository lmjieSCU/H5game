class Chunli_Player extends Chunli_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_bo_ss"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_qixing"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["sk_s_bo"]);
        skill_array.push([d, f, d, f, k]);
        skill_mapping.push(["sk_s_fengyi"]);
        skill_array.push([f, d, f, k]);
        skill_mapping.push(["sk_shengtian"]);
        skill_array.push([d, f, k]);
        skill_mapping.push(["sk_bailietui"]);
        skill_array.push([d, b, k]);
        skill_mapping.push(["sk_huixuan"]);
        skill_array.push([d, f, p]);
        skill_mapping.push(["sk_bo"]);
