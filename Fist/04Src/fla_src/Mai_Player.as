class Mai_Player extends Mai_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_heti"]);
        skill_array.push([d, b, s]);
        skill_mapping.push(["sk_s_qianzai1"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["sk_s_shuiniao"]);
        skill_array.push([d, b, f, k]);
        skill_mapping.push(["sk_s_renfeng"]);
        skill_array.push([f, d, f, k]);
        skill_mapping.push(["sk_feixiang"]);
        skill_array.push([f, d, f, p]);
        skill_mapping.push(["sk_bailu"]);
        skill_array.push([d, b, k]);
        skill_mapping.push(["sk_qianniao"]);
        skill_array.push([d, b, p]);
        skill_mapping.push(["sk_longyanwu"]);
        skill_array.push([b, d, f, k]);
        skill_mapping.push(["sk_renfeng"]);
        skill_array.push([d, f, k]);
        skill_mapping.push(["sk_renfeng"]);
        skill_array.push([d, f, p]);
        skill_mapping.push(["sk_huadieshan"]);
    } // End of the function
