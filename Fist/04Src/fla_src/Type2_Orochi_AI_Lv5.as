...
{
    var combo_rate0, attack_rate0, hold_rate0, attack_s0, wait_frame0, combo_risk, dis_array, skill_dis, dis_num, combo_1, combo_land, combo_auto, combo_burst, delay_frames, combo_oppOnEgde, action_1, actionType, cpu_attack, cpu_control2, delayTimer, opp, dir, mc;
    ...
    function combo_init()
    {
        ...
        combo_burst.sk_dfp2_l = ["sk_dbp2", "sk_s_zhuanpan", "sk_s_lunhui"];
        combo_burst.sk_dfp2 = ["sk_dbp2", "sk_s_zhuanpan", "sk_s_lunhui"];
        ...
        combo_burst.sk_s_lunhui = ["sk_s_zhuanpan", "sk_s_jiguang", "sk_s_sanhua"];
