class Iori_AI extends Iori_role
{
    var toSkill_temp, toStatus, toStatus_temp, noAct, dis_array, skill_dis, skill2_dis, _x, opp, dis, winTimes, actionType, cpu_control2, combo_rate0, combo_rate, attack_rate0, attack_rate, hold_rate0, hold_rate, attack_s, wait_frame0, wait_frame, life, life_max, dir, onEgde, status_2, status_3, status_4, inBurst, redBlood, burst, skill_list, dis_num, superCheck, burst_mode, inCount, status_1, land_Y, skillObj, mc, comboClass, _currentframe, skill_now, onHit, skill_next, delay, inFreeze, control, statusClear, checkSide, showHits_end, delaySkill, skill_delay, skillSuperCheck, powerDecType, burstCheck, powerDec, powerDec2, powerDecType2, delayTimer, Vx, gotoAndStop, Vwalk, Vdash, Vy, Vjump_x, Vjump_y, holdFreeze, jumpSkill, _y, checkSide_abs;
    function Iori_AI()
    {
        super();
    ...
    function CPU_check(act)
    {
        var _loc2 = int(Math.random() * 100);
        if (act == "sk4" && _loc2 < attack_s)
        {
            skill_next = this.selectOne(["punch", "sk_s1", "sk_s_caihu"]);
            this.checkSide_abs();
            this.combo_start();
        } // end if
    } // End of the function
