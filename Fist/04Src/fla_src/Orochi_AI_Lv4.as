class Orochi_AI_Lv4 extends Orochi_AI
{
    var combo_rate0, attack_rate0, hold_rate0, attack_s0, wait_frame0, combo_risk, dis_array, skill_dis, dis_num, combo_1, combo_land, combo_auto, combo_burst, delay_frames, action_1, delayTimer, opp, dir, mc;
    function Orochi_AI_Lv4()
    {
        super();
        this.skill_init();
        this.combo_init();
