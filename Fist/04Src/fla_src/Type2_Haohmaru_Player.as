class Type2_Haohmaru_Player extends Type2_Haohmaru_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["df_o_EX"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["db_o_EX"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["fdbf_p_EX"]);
        skill_array.push([d, f, d, f, k]);
        skill_mapping.push(["dfdf_k_EX"]);
        ...
        skill_mapping.push(["fdf_kl"]);
        skill_array.push([f, d, b, k]);
        skill_mapping.push(["fdb_k"]);
        skill_array.push([b, d, b, p]);
        skill_mapping.push(["bdb_p_EX"]);
        skill_array.push([f, d, f, k]);
        skill_mapping.push(["fdf_k"]);
        skill_array.push([d, f, p_l]);
        skill_mapping.push(["df_plEX"]);
        skill_array.push([d, f, p]);
        skill_mapping.push(["df_pEX"]);
        skill_array.push([d, f, k_l]);
        skill_mapping.push(["df_klEX"]);
        skill_array.push([d, f, k]);
        skill_mapping.push(["df_k_EX"]);
    } // End of the function
