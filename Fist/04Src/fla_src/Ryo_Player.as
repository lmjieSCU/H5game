class Ryo_Player extends Ryo_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_swms"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_sys"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["sk10"]);
        skill_array.push([d, b, d, b, k]);
        skill_mapping.push(["sk14"]);
        skill_array.push([d, b, d, b, p]);
        skill_mapping.push(["sk13"]);
        skill_array.push([f, d, f, p_l]);
        skill_mapping.push(["sk3_l"]);
        skill_array.push([f, d, f, p]);
        skill_mapping.push(["sk3"]);
        skill_array.push([f, d, f, k]);
        skill_mapping.push(["sk_SKF"]);
        skill_array.push([b, d, b, k]);
        skill_mapping.push(["sk_SKB"]);
        skill_array.push([d, f, p_l]);
        skill_mapping.push(["sk1_l"]);
        skill_array.push([d, f, p]);
        skill_mapping.push(["sk1"]);
        skill_array.push([d, b, p]);
        skill_mapping.push(["sk_bodong_air"]);
        skill_array.push([d, b, k]);
        skill_mapping.push(["sk2"]);
    } // End of the function
