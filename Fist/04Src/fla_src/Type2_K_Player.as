class Type2_K_Player extends Type2_K_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_sanduan_2"]);
        skill_array.push([d, f, k_l]);
        skill_mapping.push(["sk_dfk_hit"]);
        skill_array.push([d, f, k]);
        skill_mapping.push(["sk_dfk"]);
        skill_array.push([d, b, k]);
        skill_mapping.push(["sk_dbk_2"]);
    } // End of the function
