class Igniz_AI_Lv1 extends Igniz_AI
{
    var combo_rate0, attack_rate0, hold_rate0, attack_s0, wait_frame0, combo_risk, dis_array, skill_dis, skill2_dis, dis_num, combo_1, combo_land, combo_auto, combo_burst, delay_frames, combo_oppOnEgde, action_1, actionType, cpu_attack, cpu_control2;
    function Igniz_AI_Lv1()
    {
        super();
        this.skill_init();
        this.combo_init();
