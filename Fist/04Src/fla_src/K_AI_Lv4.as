class K_AI_Lv4 extends K_AI
{
    ...
    function skill_init()
    {
        ...
        dis_array[5] = 400;
        dis_array[6] = 1000;
        skill_dis[0] = ["punch", "punch_l", "punch_s1", "kick_l", "kick_s2", "kick", "sk_dfp", "walk_f"];
        skill_dis[1] = ["squatKick", "sk_dfp", "sk_fdfp", "sk_fdfp2", "heavyHit"];
        skill_dis[2] = ["sk_dfp", "sk_fdfp", "sk_dfk", "jump_f"];
        skill_dis[3] = ["sk_dfp", "walk_f", "jump_f"];
        skill_dis[4] = ["sk_dfp", "sk_dfk", "sk_dbk", "walk_f", "dash_f", "jump_f"];
        skill_dis[5] = ["sk_dfp", "sk_dfp", "dash_f", "dash_f"];
