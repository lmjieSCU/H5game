class Type3_Iori_AI extends Type3_Iori_role
{
    ...
    function CPU_check(act)
    {
        ...
        {
            skill_next = this.selectOne(["punch", "punch", "sk3", "sk_s1"]);
            this.checkSide_abs();
            this.combo_start();
        } // end if
    } // End of the function
