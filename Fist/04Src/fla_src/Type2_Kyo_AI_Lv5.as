class Type2_Kyo_AI_Lv5 extends Type2_Kyo_AI
{
    ...
    function skill_init()
    {
        ...
        skill_dis[3] = ["sk43", "walk_f", "jump_f"];
        skill_dis[4] = ["sk30", "walk_f", "dash_f", "jump_f"];
        skill_dis[5] = ["dash_f", "walk_f", "sk30"];
        skill_dis[6] = ["dash_f", "dash_f", "sk30"];
        skill2_dis[0] = ["punch", "kick", "squatPunch"];
        skill2_dis[1] = ["kick", "sk43_l", "squatKick", "squatKick_s"];
        skill2_dis[2] = ["sk30", "sk43", "jump_f"];
        skill2_dis[3] = ["sk30", "sk43", "sk_canggui", "jump_f"];
        skill2_dis[4] = ["sk30", "sk_canggui", "dash_f"];
        skill2_dis[5] = ["dash_f", "sk30"];
        skill2_dis[6] = ["dash_f", "sk30"];
    ...
    function combo_init()
    {
        ...
        combo_land.sk1_2 = ["sk43", "sk0", "sk_longche", "sk2", "sk31", "sk_s_120"];
        delay_frames.sk1_2 = [0, 0, 6, 0, 2, 2, 0];
        ...
        combo_oppOnEgde.sk28 = [true, true, true, true, true, true];
        combo_burst.sk_s_120 = ["sk34", "sk34", "sk35", "sk31"];
        combo_oppOnEgde.sk_s_120 = [false, false, true, true];
        combo_burst.sk31 = ["sk_s_120", "sk34", "sk35"];
        action_1 = new Object();
        ...
        action_1.oppJump = [["sk0", "squatPunch"], ["sk0"]];
        ...
        action_1.defendAttack = [["sk0", "hold_u", "hold_u"]];
        ...
        action_1.busrt = [["sk35", "sk_s34"], ["sk_s34"]];
        delay_frames.busrt = [250, 500];
    } // End of the function
} // End of Class
