        ...
        if (onHit)
        {
            ...
            if (_loc3 < 250)
            {
                if (Math.random() < 0.700000)
                {
                    this.sk_dfp_s3();
                    skill_now = "sk_dfp_s3";
                    comboClass.combo2.sk_dfp_s3 = 18;
                }
                else
                {
                    this.sk_sanduan_2();
                    skill_now = "sk_sanduan_2";
                } // end else if
                if (comboClass.combo2[status_1] != undefined)
                {
                    this.combo_wait(skill_now);
                } // end if
            } // end if
        }
        else
