class K_AI_Lv5 extends K_AI
{
    ...
    function skill_init()
    {
        ...
        skill_dis[4] = ["sk_dfp", "sk_dbp", "sk_dfk", "sk_dbk", "walk_f", "dash_f", "jump_f"];
        ...
        skill2_dis[2] = ["sk_dfk", "sk_dbk", "jump_f"];
        skill2_dis[3] = ["sk_dfk", "sk_dbk", "jump_f"];
        skill2_dis[4] = ["sk_dfk", "sk_dbk", "dash_f"];
        skill2_dis[5] = ["sk_dbk", "dash_f"];
        skill2_dis[6] = ["sk_dbk", "dash_f"];
    ...
    function combo_init()
    {
        ...
        combo_1.punch2 = ["sk_dfp", "sk_dfp", "sk_dfk", "punch_s1", "kick_s2", "kick_s2", "sk_fdfp", "sk_s1"];
        combo_1.punch_l = ["punch_l", "kick_l", "squatKick_l", "punch"];
        combo_1.kick = ["sk_dbk", "sk_dfp"];
        combo_1.kick2 = ["sk_dfp", "sk_dfp", "sk_dfk", "punch_s1", "kick_s2", "kick_s2", "sk_fdfp", "sk_s1"];
        ...
        combo_burst.punch2 = ["sk_dfp", "kick_s2", "sk_s1", "sk_s4", "sk_s5"];
        combo_burst.kick2 = ["sk_dfp", "kick_s2", "sk_s1", "sk_s4", "sk_s5"];
        combo_burst.kick_s2 = ["sk_dfp"];
        combo_burst.sk_fdfp2 = ["sk_dbk"];
        combo_burst.sk_s3 = ["sk_s1"];
        combo_oppOnEgde.sk_s3 = [true];
        combo_land.jump_f = ["punch", "kick"];
        combo_land.sk_dfp_s3 = ["sk_dbk", "sk_dfk", "sk_s1", "sk_s3"];
        ...
        combo_1.walk_b = ["punch_l", "kick_l", "jump", "jump_f", "sk_dbk"];
        ...
        action_1.oppJump = [["sk_fdfp", "sk_fdfp2"], ["sk_fdfp", "jump"]];
        ...
        action_1.defendAttack = [["sk_fdfp", "sk_fdfp2", "hold_u"], ["sk_s1", "sk_s3", "hold_u", "hold_u"]];
