class Type2_Ryo_Player extends Type2_Ryo_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_q2"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_q1"]);
