class Type2_Kula_AI_Lv1 extends Type2_Kula_AI
{
    ...
    function combo_init()
    {
        ...
        combo_1.punch2 = ["sk_flyKick", "sk_dfp", "sk_fdfp", "sk_bingdian", "sk_s_handong", "sk_tibing2"];
        combo_1.punch_l = ["punch_l", "kick_l"];
        combo_1.kick = ["sk_flyKick", "sk_dfp", "sk_fdfp", "sk_bingdian", "sk_tibing2", "sk_s_xiangdong", "sk_s_luobing"];
        combo_1.kick2 = ["sk_flyKick", "sk_dfp", "sk_fdfp", "sk_bingdian", "sk_tibing2", "sk_s_xiangdong", "sk_s_luobing"];
        ...
        combo_1.dash_f = ["punch", "kick", "jump_f"];
        delay_frames.dash_f = [130, 200, 250];
        ...
        action_1.defendAttack = [["sk_fdfp"]];
        delay_frames.defendAttack = [250];
