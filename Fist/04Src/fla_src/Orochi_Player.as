class Orochi_Player extends Orochi_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_qianshou1"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_taoxin"]);
        skill_array.push([d, f, b, p]);
        skill_mapping.push(["sk_s_guangzhu"]);
        skill_array.push([d, b, f, p]);
        skill_mapping.push(["sk_s_yangguang"]);
        skill_array.push([d, f, p]);
        skill_mapping.push(["sk_dfp"]);
        skill_array.push([d, b, p_l]);
        skill_mapping.push(["sk_dfk_l"]);
