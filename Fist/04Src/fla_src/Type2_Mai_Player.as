class Type2_Mai_Player extends Type2_Mai_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_heti2"]);
        skill_array.push([d, b, s]);
        skill_mapping.push(["sk_s_fenshen"]);
        skill_array.push([d, f, d, f, k]);
        skill_mapping.push(["sk_s_hualan"]);
        skill_array.push([d, b, d, b, p]);
        skill_mapping.push(["sk_s_fenghuang"]);
        skill_array.push([f, d, f, p]);
        skill_mapping.push(["sk_bailu2"]);
        skill_array.push([d, b, k]);
        skill_mapping.push(["sk_longyanwu2"]);
        skill_array.push([d, b, p]);
        skill_mapping.push(["sk_luan1"]);
        skill_array.push([b, d, f, k]);
        skill_mapping.push(["sk_hulu"]);
