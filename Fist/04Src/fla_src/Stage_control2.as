...
{
    var _lockroot, bgSource, stageW, stageH, stage_c, stage_l, stage_r, char_mc, P1, P2, roleCharse_y, bgObjArray, bgMCArray, bgLoader, bg_base;
    static var self;
    ...
    function startControl(c_target, rate_x, rate_y)
    {
        if (c_target == P1)
        {
            ...
            {
                this.camera_role(P1, rate_x, rate_y);
            } // End of the function
        }
        else if (c_target == P2)
        {
            ...
            function onEnterFrame()
            {
                this.camera_role(P2, rate_x, rate_y);
            } // End of the function
        }
        else
        {
            roleCharse_y = P1._y < P2._y ? (P1._y) : (P2._y);
            function onEnterFrame()
            {
                this.camera_center();
            } // End of the function
    ...
    function initObj()
    {
        bgObjArray = bgSource.bgArray;
        bgMCArray = new Array();
        bgLoader = bgSource;
        for (var _loc3 = 0; _loc3 < bgObjArray.length; ++_loc3)
        {
            if (bgObjArray[_loc3].isBmd)
            {
