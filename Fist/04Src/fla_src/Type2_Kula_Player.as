class Type2_Kula_Player extends Type2_Kula_role
{
    ...
    function skill_code()
    {
        ...
        skill_mapping.push(["sk_s_storm"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_luanren"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["sk_s_handong"]);
        skill_array.push([d, f, d, b, p]);
        skill_mapping.push(["sk_s_xiangdong"]);
        skill_array.push([d, f, b, p]);
        skill_mapping.push(["sk_s_xiangdong"]);
        skill_array.push([d, f, d, f, k]);
        skill_mapping.push(["sk_s_luobing"]);
        ...
        skill_mapping.push(["sk_flyKick"]);
        skill_array.push([d, f, k_l]);
        skill_mapping.push(["sk_tibing1"]);
        skill_array.push([d, f, k]);
        skill_mapping.push(["sk_tibing2"]);
    } // End of the function
