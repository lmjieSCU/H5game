class Kula_AI_Lv5 extends Kula_AI
{
    ...
    function skill_init()
    {
        ...
        skill_dis[2] = ["sk_dfp", "sk_dbk", "sk_dbk_l", "sk_bingdian", "jump_f"];
        skill_dis[3] = ["sk_dbk", "walk_f", "dash_f", "jump_f"];
        skill_dis[4] = ["dash_f", "walk_f"];
        skill_dis[5] = ["dash_f", "walk_f", "sk_tibing1"];
        skill2_dis[0] = ["punch", "punch", "kick"];
        skill2_dis[1] = ["squatKick", "kick"];
        skill2_dis[2] = ["sk_dfp", "sk_dbk", "sk_bingdian", "jump_f"];
        skill2_dis[3] = ["sk_dbk", "sk_bingdian", "sk_tibing1", "jump_f"];
        skill2_dis[4] = ["sk_tibing1", "dash_f"];
        skill2_dis[5] = ["sk_tibing1", "dash_f"];
    ...
    function combo_init()
    {
        ...
        combo_burst.sk_s_bingren = ["sk_s_xingchen", "sk_s_jiejie"];
        combo_burst.sk_tibing = ["sk_s_xingchen"];
        combo_oppOnEgde.sk_tibing = [true];
