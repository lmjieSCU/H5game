class Moriya_AI_Lv5 extends Moriya_AI
{
    ...
    function combo_init()
    {
        ...
        combo_1.punch2 = ["sk_long_m", "sk_long_d", "sk_yueying_a1", "sk_yueying_c1", "sk_s1", "sk_s2"];
        combo_1.punch_l = ["punch_l", "kick_l"];
        combo_1.kick = ["sk_long_m", "sk_long_d", "sk_yueying_a1", "sk_yueying_c1"];
        combo_1.squatPunch = ["sk_long_m", "sk_long_d", "sk_yueying_a1", "sk_yueying_c1", "sk_s1", "sk_s2"];
        ...
        combo_burst.sk_long_m = ["sk_long_d", "sk_yueying_a1", "sk_yueying_c1", "sk_s2"];
        combo_burst.sk_long_d = ["sk_long_m", "sk_yueying_a1", "sk_yueying_c1", "sk_s2"];
        combo_burst.sk_yueying_a1 = ["sk_yueying_a2", "sk_yueying_c1", "sk_xinyue", "sk_xinyue2", "sk_s1", "sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_yueying_a2 = ["sk_yueying_a3", "sk_yueying_c1", "sk_xinyue", "sk_xinyue2", "sk_s1", "sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_yueying_c1 = ["sk_yueying_c2", "sk_yueying_a1", "sk_xinyue", "sk_xinyue2", "sk_s1", "sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_yueying_c2 = ["sk_yueying_c3", "sk_yueying_a1", "sk_xinyue", "sk_xinyue2", "sk_s1", "sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_yueying_c3 = ["sk_yueying_c4", "sk_yueying_a1", "sk_xinyue", "sk_xinyue2", "sk_s1", "sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_s1 = ["sk_s2", "sk_s3", "sk_s4"];
        combo_burst.sk_s2 = ["sk_s3", "sk_s4"];
