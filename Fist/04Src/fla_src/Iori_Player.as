class Iori_Player extends Iori_role
{
    ...
    function skill_code()
    {
        skill_array.push([d, b, d, f, p]);
        skill_mapping.push(["sk_s_89b"]);
        skill_array.push([f, d, b, f, p]);
        skill_mapping.push(["sk4"]);
        skill_array.push([b, d, f, p]);
        skill_mapping.push(["sk4"]);
        skill_array.push([d, b, s]);
        skill_mapping.push(["sk_s_3shenji2"]);
        skill_array.push([d, f, s]);
        skill_mapping.push(["sk_s_qianzai2"]);
        skill_array.push([d, b, f, p]);
        skill_mapping.push(["sk_s_89b"]);
        skill_array.push([d, f, d, f, p]);
        skill_mapping.push(["sk_s_caihua0"]);
