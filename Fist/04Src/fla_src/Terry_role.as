class Terry_role extends role_corn.Role
{
    ...
    function Terry_role()
    {
        ...
        Vjump_far = 20;
        opp_width2 = 60;
        superList = {dbdf_p: 1, dfdf_k: 1};
        burstList = {df_o: 1, db_o: 1};
        superMaxList = {dbdf_p_max: 1, dfdf_k_max: 1};
        skillSuperMapping = {dbdf_p: "dbdf_p_max", dfdf_k: "dfdf_k_max"};
        ...
        comboClass = new Terry_Combo(this);
        this.preCheck();
