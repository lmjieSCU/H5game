class Iori_AI_Lv4 extends Iori_AI
{
    ...
    function skill_init()
    {
        ...
        skill_dis[1] = ["punch", "squatKick", "sk1_1", "sk0", "heavyHit"];
        skill_dis[2] = ["sk1_1", "sk2", "jump_f"];
        skill_dis[3] = ["sk2", "jump_f", "walk_f"];
    ...
    function combo_init()
    {
        ...
        combo_1.dash_f = ["punch_l", "kick_l", "roll_f", "punch_s1", "jump_f", "jump"];
