class Type2_Ryo_AI extends Type2_Ryo_role
{
   var attack_s0 = 30;
   var combo_risk = 50;
   ...
   function air_check()
   {
      ...
      if(this.opp.status_2 == "air")
      {
         if(this.getDis() < 150)
         {
            ...
            {
               if(_loc2_ < 45 && _loc2_ < this.attack_s)
               {
                  this.toSkill("sk4");
                  return undefined;
               }
               if(_loc2_ < 60 && _loc2_ < this.attack_s)
               {
                  this.toSkill("sk_bodong_air");
                  return undefined;
               }
               _loc3_ = "kick";
            }
      ...
      else if(this._y > this.land_Y - 150 && this.Vy < 0)
      {
         ...
         {
            if(_loc2_ < 80 && _loc2_ < this.attack_s)
            {
               this.toSkill("sk4");
               return undefined;
            }
            if(_loc2_ < 90 && _loc2_ < this.attack_s)
            {
               this.toSkill("sk4");
               return undefined;
            }
