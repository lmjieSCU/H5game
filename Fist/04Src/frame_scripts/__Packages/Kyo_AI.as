class Kyo_AI extends Kyo_role
{
   ...
   {
      var _loc2_ = int(Math.random() * 100);
      if(act == "sk31" && _loc2_ < this.attack_s && this.inBurst && this.burst_mode == "attack")
      {
         this.skill_next = this.selectOne(["sk29","sk3","sk0"]);
         this.combo_start();
      }
      else if(act == "sk28" && _loc2_ < this.attack_s && this.inBurst && this.burst_mode == "attack")
      {
         this.skill_next = this.selectOne(["sk0","sk1","heavyHit","sk29","sk31","sk3"]);
         this.skill_next = this.selectOne(["sk0","sk1","heavyHit","sk29","sk31","sk3"]);
         this.combo_start();
      }
   }
