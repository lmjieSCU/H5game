class Type2_Kula_AI_Lv5 extends Type2_Kula_AI
{
   ...
   function skill_init()
   {
      ...
      this.skill2_dis[1] = ["squatKick","kick","sk_tibing2"];
      this.skill2_dis[2] = ["sk_dfp","sk_flyKick","sk_bingdian","sk_tibing2","jump_f"];
      this.skill2_dis[3] = ["sk_flyKick","sk_bingdian","jump_f"];
   ...
   function combo_init()
   {
      ...
      this.combo_burst.sk_s_bingren = ["sk_s_luobing","sk_s_storm","sk_s_luanren"];
      ...
      this.action_1.defendAttack = [["sk_fdfp","sk_s_xiangdong","sk_s_luanren"],["sk_s_handong","sk_s_luobing","sk_s_storm","sk_s_luanren"]];
      this.delay_frames.defendAttack = [250,1000];
