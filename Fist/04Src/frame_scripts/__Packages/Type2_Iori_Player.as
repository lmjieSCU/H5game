class Type2_Iori_Player extends Type2_Iori_role
{
   ...
   function skill_code()
   {
      this.skill_array.push([this.f,this.d,this.b,this.f,this.p]);
      this.skill_mapping.push(["sk_CChun"]);
      this.skill_array.push([this.b,this.d,this.f,this.p]);
      this.skill_mapping.push(["sk_CChun"]);
      this.skill_array.push([this.d,this.f,this.s]);
      this.skill_mapping.push(["sk_s_zhuangqiang"]);
   ...
   {
      if(_level0.timeOver && this.status_1 == "stand")
      {
         this.stand();
      }
      if(this.opp.isKO && this.status_1 == "stand")
      {
         this.stand();
      }
