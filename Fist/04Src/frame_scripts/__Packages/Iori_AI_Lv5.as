class Iori_AI_Lv5 extends Iori_AI
{
   ...
   function skill_init()
   {
      ...
      this.skill_dis[0] = ["punch_l","punch_s1","kick_l","kick_l","squatPunch","walk_f","sk4"];
      this.skill_dis[1] = ["sk1_1","punch_s1"];
      this.skill_dis[2] = ["sk1_1","walk_f"];
      this.skill_dis[3] = ["sk2","sk1_1","walk_f","dash_f"];
      ...
      this.skill2_dis[0] = ["punch","kick","squatPunch","walk_f","sk4"];
      this.skill2_dis[1] = ["punch","kick","sk1_1"];
      this.skill2_dis[2] = ["sk1_1","sk3","jump_f"];
      this.skill2_dis[3] = ["jump_f","sk3"];
      this.skill2_dis[4] = ["sk2","jump_f"];
      this.skill2_dis[5] = ["sk2","dash_f"];
      this.skill2_dis[6] = ["sk2","dash_f"];
   }
   function combo_init()
   {
      ...
      this.combo_1.punch2 = ["sk1_1","sk2","sk3","sk_s1"];
      this.combo_1.kick = ["sk2"];
      this.combo_1.kick2 = ["sk1_1","sk2","sk3","sk_s1"];
      ...
      this.combo_1.sk_s1 = [["sk_s_caihua"],["sk_s1","sk_s_89b"]];
      ...
      this.action_1.wander = [["roll_b","dash_b"],["wait","jump_b","walk_b","dash_b"],["dash_f","wait"]];
      this.delay_frames.wander = [150,300,1000];
      this.action_1.defend = [["walk_b","walk_b","roll_f"],["walk_b","roll_b"],["walk_b","dash_b","jump_b","roll_b"],["walk_f","walk_b","wait"]];
