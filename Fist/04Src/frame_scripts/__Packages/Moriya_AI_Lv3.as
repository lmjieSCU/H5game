class Moriya_AI_Lv3 extends Moriya_AI
{
   ...
   function combo_init()
   {
      ...
      this.combo_1.punch2 = ["sk_long_m","sk_long_d","sk_yueying_a1","sk_yueying_c1","sk_s2"];
      this.combo_1.punch_l = ["punch_l","kick_l"];
      this.combo_1.kick = ["sk_long_m","sk_long_d","sk_yueying_a1","sk_yueying_c1"];
      this.combo_1.squatPunch = ["sk_long_m","sk_long_d","sk_yueying_a1","sk_yueying_c1","sk_s1"];
      ...
      this.combo_burst.sk_yueying_a1 = ["sk_yueying_a2","sk_yueying_c1","sk_xinyue","sk_xinyue2","sk_s1"];
      this.combo_burst.sk_yueying_a2 = ["sk_yueying_a3","sk_yueying_c1","sk_xinyue","sk_xinyue2","sk_s2"];
      this.combo_burst.sk_yueying_c1 = ["sk_yueying_c2","sk_yueying_a1","sk_xinyue","sk_xinyue2","sk_s3"];
      this.combo_burst.sk_yueying_c2 = ["sk_yueying_c3","sk_yueying_a1","sk_xinyue","sk_xinyue2","sk_s4"];
      this.combo_burst.sk_yueying_c3 = ["sk_yueying_c4","sk_yueying_a1","sk_xinyue","sk_xinyue2","sk_s1"];
