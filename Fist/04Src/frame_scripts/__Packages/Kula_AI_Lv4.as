class Kula_AI_Lv4 extends Kula_AI
{
   ...
   function combo_init()
   {
      ...
      this.combo_burst.sk_s_bingren = ["sk_fdfp","sk_dbk","sk_bingdian","sk_s_xingchen","sk_s_jiejie"];
      this.combo_burst.sk_tibing = ["sk_fdfp","sk_dbk","sk_s_xingchen"];
      this.combo_oppOnEgde.sk_tibing = [true,true,true];
      this.combo_1.dash_f = ["kick","punch","squatKick_l","squatPunch_l","roll_f","jump_f","sk_huaxing"];
      this.delay_frames.dash_f = [130,130,130,130,130,250,250];
      this.combo_1.walk_f = ["pitch","punch_l","punch","kick","jump_f","dash_f"];
      this.delay_frames.walk_f = [100,150,150,180,250,400];
