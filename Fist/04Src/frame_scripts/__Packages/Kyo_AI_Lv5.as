class Kyo_AI_Lv5 extends Kyo_AI
{
   ...
   function skill_init()
   {
      ...
      this.skill_dis[1] = ["kick_l","sk1","sk0","heavyHit","sk_hezhai","squatKick","squatKick_s"];
      this.skill_dis[2] = ["kick_l","sk15","sk19","jump_f"];
      this.skill_dis[3] = ["sk19","sk2","sk15","jump_f","walk_f"];
      this.skill_dis[4] = ["sk19","sk2","dash_f","jump_f"];
      this.skill_dis[5] = ["dash_f","dash_f","sk15"];
      this.skill_dis[6] = ["dash_f","dash_f","walk_f"];
      this.skill2_dis[0] = ["punch","kick","squatPunch"];
      this.skill2_dis[1] = ["kick","squatKick","squatKick_s"];
      this.skill2_dis[2] = ["sk15","sk28","jump_f"];
      this.skill2_dis[3] = ["sk15","sk19","sk2","sk28","jump_f"];
      this.skill2_dis[4] = ["sk2","sk28","jump_f"];
      this.skill2_dis[5] = ["sk28","dash_f"];
      this.skill2_dis[6] = ["dash_f"];
   ...
   function combo_init()
   {
      ...
      this.combo_land.sk1_2 = ["sk15","sk19","sk0","sk2","heavyHit","sk31"];
      this.delay_frames.sk1_2 = [1,3,0,2,0,2];
      ...
      this.combo_burst.heavyHit = ["sk29","sk31","sk3"];
      this.combo_burst.sk15 = ["sk16","sk16","sk19","sk28","sk1"];
      this.combo_burst.sk16 = ["sk19","sk19","sk1","heavyHit","sk28","sk29","sk31"];
      this.combo_burst.sk19 = ["sk20","sk20","heavyHit","sk1","sk28"];
      this.combo_burst.sk20 = ["sk1","heavyHit","sk29","sk31","sk3"];
      this.combo_burst.sk28 = ["sk29","sk31","sk3"];
      this.combo_oppOnEgde.sk28 = [true,true,true];
      this.combo_burst.sk29 = ["sk31","sk3","sk0","sk_s3"];
      this.combo_burst.sk31 = ["sk29","sk3","sk0","sk_s3"];
      this.combo_oppOnEgde.sk31 = [true,true,true,true];
      ...
      this.action_1.defendAttack = [["sk_hezhai","sk0","hold_u","hold_u"]];
