class Type2_Orochi_AI_Lv5 extends Type2_Orochi_AI
{
   function Type2_Orochi_AI_Lv5()
   {
      super();
      this.skill_init();
      this.combo_init();
   ...
   function skill_init()
   {
      ...
      this.skill_dis[1] = ["punch","kick_l","kick","squatPunch","sk_dfp2_l","heavyHit"];
      this.skill_dis[2] = ["kick","sk_dfp2_l","sk_dbp2_l"];
      this.skill_dis[3] = ["sk_dfp2_l","sk_dbp2_l","dash_f","walk_f","jump_f"];
      this.skill_dis[4] = ["sk_dfp2","sk_dbp2","walk_f","dash_f"];
   ...
   function combo_init()
   {
      ...
      this.combo_1.punch = ["sk_dfp2_l","sk_dbp2","sk_dbp_l","sk_s_zhuanpan","sk_s_lunhui"];
      this.combo_1.kick_l = ["sk_dfp2_l","sk_dbp2","sk_dbp_l","sk_s_zhuanpan","sk_s_lunhui"];
      this.combo_1.kick = ["sk_s_zhuanpan","sk_s_lunhui","sk_dfp2_l","sk_dbp2"];
      this.combo_oppOnEgde.kick = [true,true];
      this.combo_burst.sk_dfp2_l = ["sk_dbp2","sk_s_zhuanpan","sk_s_lunhui"];
      this.combo_burst.sk_dfp2 = ["sk_dbp2","sk_s_zhuanpan","sk_s_lunhui"];
      this.combo_land.jump_f = ["kick"];
      this.combo_burst.kick_l = ["sk_s_zhuanpan","sk_s_lunhui","sk_s_jiguang"];
      this.combo_burst.kick = ["sk_s_zhuanpan","sk_s_lunhui"];
      this.combo_oppOnEgde.kick = [true,true];
      this.combo_burst.sk_dfp2_l = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_dfp2 = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_dbp_l = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_dbp = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_dfk = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_dfk_l = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      this.combo_burst.sk_s_lunhui = ["sk_s_zhuanpan","sk_s_jiguang","sk_s_sanhua"];
      ...
      this.action_1.defendAttack = [["sk_dbp"],["sk_s_lunhui","sk_s_jiguang","sk_s_sanhua"]];
      ...
      this.action_1.super = [["sk_s_lunhui","sk_s_zhuanpan"].sk_s_zhuanpan];
      this.delay_frames.super = [170,600];
      this.action_1.busrt = [["sk_s_jiguang","sk_s_sanhua"],["sk_s_jiguang","sk_s_sanhua"]];
      this.delay_frames.busrt = [300,600];
   }
