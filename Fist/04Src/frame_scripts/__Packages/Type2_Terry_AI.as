class Type2_Terry_AI extends Type2_Terry_role
{
   var attack_s0 = 30;
   var combo_risk = 50;
   ...
   {
      var _loc3_ = int(Math.random() * 100);
      if(act == "xuanzhuan" && _loc3_ < this.attack_s)
      {
         if(_root.role_mc.onHit && _root.role_mc.opp.status_3 == "hurt")
         {
            this.mc.nextSkill = "sk_tibing0";
         }
         else if(_root.role_mc.onHit)
         {
            this.mc.nextSkill = "sk_huaxing";
         }
      }
   }
}
