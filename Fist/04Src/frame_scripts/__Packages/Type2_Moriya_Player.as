class Type2_Moriya_Player extends Type2_Moriya_role
{
   function Type2_Moriya_Player()
   {
      super();
   ...
   function skill_code_easy()
   {
      ...
      this.skill_mapping.push(["punch3"]);
   }
}
