class Type3_Iori_AI extends Type3_Iori_role
{
   ...
   function air_check()
   {
      ...
      else if(this._x > this.opp._x && this.dir > 0)
      {
         _loc2_ = "kick_s";
         this.jumpSkill(_loc2_);
         delete this.mc.onEnterFrame;
      ...
      else if(this._y > this.land_Y - 100 && this.Vy < 0)
      {
         _loc3_ = int(Math.random() * 100);
         if(_loc3_ < 50)
         {
   ...
   {
      var _loc2_ = int(Math.random() * 100);
      if(act == "sk4" && _loc2_ < this.attack_s)
      {
         this.skill_next = this.selectOne(["punch","punch","sk3","sk_s1"]);
         this.checkSide_abs();
         this.combo_start();
      }
   }
