class SplashScene extends Scene{
	...
	public static channel:string="tt";//不同的渠道tt, qq, wx, 4399, android
	...
	{
		UI.addPic(this, "splash_png", UI.WINSIZE_W / 2, UI.WINSIZE_H / 2, true);
	}
	...
	//
	protected onEnter() {
		let ss:string = "categ07_orig02";
		let pos1 = ss.substr(5, 2);
		let pos2 = ss.indexOf("kkk") ;
		...
		//设置为 POST 请求
		if (SplashScene.channel != "4399" && SplashScene.channel != "android") {
			...
			let url2: string = "http://139.199.14.186/serv/" + SplashScene.gameName + ".php?channel=" + SplashScene.gameChannel + "&version=" + SplashScene.version;
