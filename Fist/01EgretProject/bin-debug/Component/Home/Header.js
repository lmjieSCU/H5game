...
var Header = (function (_super) {
    ...
    Header.prototype.onEnter = function () {
        var bg = UI.addPic(this, "Home_head_png", 0, 0);
        this.headBox = UI.addPic(this, "Home_head_portrait_png", 0, 0);
        UI.addClickAction(this, this.headBox, function () { return egret.localStorage.clear(); });
        ...
        this.gold.y = 10;
        var goldBg = UI.addPic(this.gold, "Home_box_gold_png", 0, 0);
        // let gold: egret.Bitmap = UI.addPic(this.gold, "Home_box_gold_png", 0, 0);
        // gold.anchorOffsetX = gold.width / 2;
        var goldText = UI.addText(this.gold, this.personData.gold, goldBg.width / 2, goldBg.height / 2, true, 20, 0xffffff);
        var addGold = UI.addBtn(this.gold, "Home_button_add_png", goldBg.width, goldBg.height / 2, true, function () {
            console.log("addGold");
        ...
        var crystalBg = UI.addPic(this.crystal, "Home_box_crystal_png", 0, 0);
        // let crystal: egret.Bitmap = UI.addPic(this.crystal, "Home_box_crystal_png", 0, 0);
        // crystal.anchorOffsetX = crystal.width / 2;
        var crystalText = UI.addText(this.crystal, this.personData.crystal, crystalBg.width / 2, crystalBg.height / 2, true, 20, 0xffffff);
        var addCrystal = UI.addBtn(this.crystal, "Home_button_add_png", crystalBg.width, crystalBg.height / 2, true, function () {
    ...
    Header.prototype.chageHead = function (bool) {
...
__reflect(Header.prototype, "Header", ["egret.DisplayObject"]);
