...
var kula_iceFall_big2 = (function () {
    function kula_iceFall_big2() {
    }
    kula_iceFall_big2.addSprite18634 = function (mc, own_role) {
        mc.addFrameScript(mc, [1, kula_iceFall_big2.frame1, 11, kula_iceFall_big2.frame11]);
        mc["own_role"] = own_role;
        return;
    };
    kula_iceFall_big2.frame1 = function (mc) {
        ...
        mc.addWaitingCallFun(mc, ['onLand', kula_iceFall_big2.frame1_onLand, [mc], 'onHit', kula_iceFall_big2.frame1_onHit, [mc]]);
    };
    kula_iceFall_big2.frame1_onLand = function (mc) {
        mc.gotoAndStop('hit');
    };
    kula_iceFall_big2.frame1_onHit = function (mc) {
        //icebody.stop();
    };
    kula_iceFall_big2.frame11 = function (mc) {
        mc.parent.removeChild(mc);
    };
    return kula_iceFall_big2;
}());
__reflect(kula_iceFall_big2.prototype, "kula_iceFall_big2");
//# sourceMappingURL=kula_iceFall_big2.js.map