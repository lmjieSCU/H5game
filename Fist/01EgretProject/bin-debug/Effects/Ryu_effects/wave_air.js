...
var wave_air = (function () {
    function wave_air() {
    }
    wave_air.addSprite20021 = function (mc, own_role) {
        mc.addFrameScript(mc, [1, wave_air.frame1, 9, wave_air.frame9]);
        return;
    };
    wave_air.frame1 = function (mc) {
        mc.stop();
    ...
    wave_air.frame9 = function (mc) {
        mc.parent.removeChild(mc);
    };
    return wave_air;
}());
__reflect(wave_air.prototype, "wave_air");
//# sourceMappingURL=wave_air.js.map