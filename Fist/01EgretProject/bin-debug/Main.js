...
var Main = (function (_super) {
    ...
    Main.entryAlready = false;
    Main.loadResAlready = false; //预加载资源
    Main.fixed_Width = 854;
    Main.PVP_offline = "PVP_offline";
    Main.PVP_online = "PVP_online";
    Main.PVE = "pve";
    Main.EVE = "eve";
    Main.UIT1 = 'guofeng';
    Main.UIT2 = 'pengke';
    Main.UItype = Main.UIT2; //ui风格
    return Main;
