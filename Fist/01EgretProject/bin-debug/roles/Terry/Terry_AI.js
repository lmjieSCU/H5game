...
var Terry_AI = (function (_super) {
    __extends(Terry_AI, _super);
    function Terry_AI() {
    ...
    /**获得和对方的距离 */
    Terry_AI.prototype.getDis = function () {
     ...
     * 进攻/防御/停滞/普通
     */
    Terry_AI.prototype.initStage = function () {
        this.initPlus();
        var _loc2_ = 0;
    ...
    /**初始化进攻率、防御率等属性 */
    Terry_AI.prototype.initPlus = function () {
     ...
     * @3:随机选择
     */
    Terry_AI.prototype.cpu_control = function () {
    ...
    Terry_AI.prototype.cpu_control_easily = function () {
        //使用render_delay_action调用cpu_control,同时清空上一过程判断的combo_Delay
        this.render_AI_control = undefined;
        if (this.render_mc_action == this.render_combo_delay) {
            this.render_mc_action = undefined;
    ...
    Terry_AI.prototype.checkAction_easily = function () {
    ...
    Terry_AI.prototype.cpu_normal = function () {
        this.initPlus();
        if (this.checkAttack()) {
     ...
     * 防御状态下选出行为action进行执行
     */
    Terry_AI.prototype.cpu_defend = function () {
        this.initPlus();
    ...
    Terry_AI.prototype.cpu_attack = function () {
        this.initPlus();
     ...
     */
    Terry_AI.prototype.checkAction = function () {
        var action = undefined;
     ...
     * 当前状态为防御时放弃防御
     */
    Terry_AI.prototype.checkDefend = function () {
     ...
     * 进攻未结束且拥有子技能则防御
     */
    Terry_AI.prototype.isNeedDefend = function () {
    ...
    /**进攻判断*/
    Terry_AI.prototype.checkAttack = function () {
     ...
     * 等待x帧后进入攻击
     */
    Terry_AI.prototype.checkWait = function () {
    ...
    Terry_AI.prototype.render_checkWait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    /**判断是否进入爆发模式 */
    Terry_AI.prototype.checkBurst = function () {
        if (this.inBurst) {
            return false;
        }
    ...
    Terry_AI.prototype.skill_select = function () {
        this.skill_list = [];
        this.getDis();
    ...
    Terry_AI.prototype.action_select = function (object, member) {
        var aimArr = [];
    ...
    /**返回false或行动action */
    Terry_AI.prototype.super_select = function () {
    ...
    /**返回false或行动action */
    Terry_AI.prototype.burst_select = function () {
     ...
     * bug:walk_f无坐标移动
     */
    Terry_AI.prototype.attack_start = function () {
     ...
     * 判断出是蹲防还是站防
     */
    Terry_AI.prototype.defend_start = function () {
        var action = undefined;
        this.getDis();
    ...
    /**等待_level0添加必防列表 */
    Terry_AI.prototype.checkMustDefendSkill = function (oppSkill) {
    ...
    Terry_AI.prototype.actionDefend = function (action) {
        if (this.status_2 != "land") {
            return undefined;
        }
        if (this.status_3 != "normal") {
    ...
    Terry_AI.prototype.combo_wait = function (status_1) {
    ...
    Terry_AI.prototype.render_combo_wait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Terry_AI.prototype.combo_check = function () {
     ...
     * 进攻率低于连招率
     */
    Terry_AI.prototype.combo_check_land = function () {
        var attack_ratio = Math.floor(Math.random() * 500);
     ...
     */
    Terry_AI.prototype.combo_select = function (comboType) {
    ...
    Terry_AI.prototype.combo_start = function () {
        if (this.skill_next == undefined) {
            return;
        }
        if (this.delay == 0) {
     ...
     * 很重要
    */
    Terry_AI.prototype.combo_delay = function () {
    ...
    Terry_AI.prototype.render_combo_delay = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Terry_AI.prototype.start_control = function () {
        this.control = true;
        this.initStage();
    ...
    Terry_AI.prototype.toStatus_switch = function (action) {
    ...
    Terry_AI.prototype.toSkill = function (action, cancle) {
     ...
     * 行为2为移动
     */
    Terry_AI.prototype.move_walkRun = function () {
        this.render_mc_action = undefined;
    ...
    Terry_AI.prototype.render_move_walkRun = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Terry_AI.prototype.move_squat = function () {
    };
    Terry_AI.prototype.move_hold = function () {
        this.DEBUG_LOG("move_hold");
        // egret.clearInterval(this.delayTimer);
        this.render_bodyMC_action = this.render_move_hold;
        this.render_bodyMC_action_params = [];
    };
    Terry_AI.prototype.render_move_hold = function () {
     ...
     * 控制人物 */
    Terry_AI.prototype.stand = function () {
     ...
     * 控制人物 */
    Terry_AI.prototype.squat = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
        this.statusClear();
    ...
    Terry_AI.prototype.attack = function () {
        this.attack_start();
    };
    Terry_AI.prototype.wait = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
        this.checkWait();
     ...
     * 站起后立即进攻
     */
    Terry_AI.prototype.waitStand = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
    ...
    Terry_AI.prototype.render_waitStand = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Terry_AI.prototype.walk_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.walk_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.dash_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.dash_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.hold = function () {
        return this.hold_u();
    };
    Terry_AI.prototype.hold_u = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.hold_d = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.jump_f = function () {
        if (this.status_2 != "land") {
            return false;
        }
    ...
    Terry_AI.prototype.jump_b = function () {
        if (this.status_2 != "land") {
            return false;
        }
        this.render_bodyMC_action = this.render_jump;
    ...
    Terry_AI.prototype.jump = function () {
        if (this.status_2 != "land") {
            return false;
        }
        this.render_bodyMC_action = this.render_jump;
    ...
    Terry_AI.prototype.punch = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Terry_AI.prototype.pitch = function () {
        if (!_super.prototype.pitch.call(this)) {
            return this.punch();
        }
        return true;
    };
    Terry_AI.prototype.kick2 = function () {
        this.mc.gotoAndStop("kick2");
        this.status_1 = "kick2";
        this.status_3 = "attack";
        return true;
    };
    Terry_AI.prototype.hold_end = function () {
        this.holdFreeze = false;
    };
    Terry_AI.prototype.selectOne = function (array) {
    ...
    Terry_AI.prototype.render_jump = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
     ...
     * 否则等待落地
     */
    Terry_AI.prototype.air_check = function () {
        if (this.getDis() > 350) {
            return undefined;
        }
        var action = undefined;
...
__reflect(Terry_AI.prototype, "Terry_AI");
//# sourceMappingURL=Terry_AI.js.map