...
var Type2_Mai_AI = (function (_super) {
    __extends(Type2_Mai_AI, _super);
    function Type2_Mai_AI() {
    ...
    /**获得和对方的距离 */
    Type2_Mai_AI.prototype.getDis = function () {
     ...
     * 进攻/防御/停滞/普通
     */
    Type2_Mai_AI.prototype.initStage = function () {
        this.initPlus();
        var _loc2_ = 0;
    ...
    /**初始化进攻率、防御率等属性 */
    Type2_Mai_AI.prototype.initPlus = function () {
     ...
     * @3:随机选择
     */
    Type2_Mai_AI.prototype.cpu_control = function () {
    ...
    Type2_Mai_AI.prototype.cpu_control_easily = function () {
        //使用render_delay_action调用cpu_control,同时清空上一过程判断的combo_Delay
        this.render_AI_control = undefined;
        if (this.render_mc_action == this.render_combo_delay) {
            this.render_mc_action = undefined;
    ...
    Type2_Mai_AI.prototype.checkAction_easily = function () {
    ...
    Type2_Mai_AI.prototype.cpu_normal = function () {
        this.initPlus();
        if (this.checkAttack()) {
     ...
     * 防御状态下选出行为action进行执行
     */
    Type2_Mai_AI.prototype.cpu_defend = function () {
        this.initPlus();
    ...
    Type2_Mai_AI.prototype.cpu_attack = function () {
        this.initPlus();
     ...
     */
    Type2_Mai_AI.prototype.checkAction = function () {
        var action = undefined;
     ...
     * 当前状态为防御时放弃防御
     */
    Type2_Mai_AI.prototype.checkDefend = function () {
     ...
     * 进攻未结束且拥有子技能则防御
     */
    Type2_Mai_AI.prototype.isNeedDefend = function () {
    ...
    /**进攻判断*/
    Type2_Mai_AI.prototype.checkAttack = function () {
     ...
     * 等待x帧后进入攻击
     */
    Type2_Mai_AI.prototype.checkWait = function () {
    ...
    Type2_Mai_AI.prototype.render_checkWait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    /**判断是否进入爆发模式 */
    Type2_Mai_AI.prototype.checkBurst = function () {
        if (this.inBurst) {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.skill_select = function () {
        this.skill_list = [];
        this.getDis();
    ...
    Type2_Mai_AI.prototype.action_select = function (object, member) {
        var aimArr = [];
    ...
    /**返回false或行动action */
    Type2_Mai_AI.prototype.super_select = function () {
    ...
    /**返回false或行动action */
    Type2_Mai_AI.prototype.burst_select = function () {
     ...
     * bug:walk_f无坐标移动
     */
    Type2_Mai_AI.prototype.attack_start = function () {
     ...
     * 判断出是蹲防还是站防
     */
    Type2_Mai_AI.prototype.defend_start = function () {
        var action = undefined;
        this.getDis();
    ...
    /**等待_level0添加必防列表 */
    Type2_Mai_AI.prototype.checkMustDefendSkill = function (oppSkill) {
    ...
    Type2_Mai_AI.prototype.actionDefend = function (action) {
        if (this.status_2 != "land") {
            return undefined;
        }
        if (this.status_3 != "normal") {
    ...
    Type2_Mai_AI.prototype.combo_wait = function (status_1) {
    ...
    Type2_Mai_AI.prototype.render_combo_wait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Type2_Mai_AI.prototype.combo_check = function () {
     ...
     * 进攻率低于连招率
     */
    Type2_Mai_AI.prototype.combo_check_land = function () {
        var attack_ratio = Math.floor(Math.random() * 500);
     ...
     */
    Type2_Mai_AI.prototype.combo_select = function (comboType) {
    ...
    Type2_Mai_AI.prototype.combo_start = function () {
        if (this.skill_next == undefined) {
            return;
        }
        if (this.delay == 0) {
     ...
     * 很重要
    */
    Type2_Mai_AI.prototype.combo_delay = function () {
    ...
    Type2_Mai_AI.prototype.render_combo_delay = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Type2_Mai_AI.prototype.start_control = function () {
        this.control = true;
        this.initStage();
    ...
    Type2_Mai_AI.prototype.toStatus_switch = function (action) {
    ...
    Type2_Mai_AI.prototype.toSkill = function (action, cancle) {
     ...
     * 行为2为移动
     */
    Type2_Mai_AI.prototype.move_walkRun = function () {
        this.render_mc_action = undefined;
    ...
    Type2_Mai_AI.prototype.render_move_walkRun = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Type2_Mai_AI.prototype.move_squat = function () {
    };
    Type2_Mai_AI.prototype.move_hold = function () {
        this.DEBUG_LOG("move_hold");
        // egret.clearInterval(this.delayTimer);
        this.render_bodyMC_action = this.render_move_hold;
        this.render_bodyMC_action_params = [];
    };
    Type2_Mai_AI.prototype.render_move_hold = function () {
     ...
     * 控制人物 */
    Type2_Mai_AI.prototype.stand = function () {
     ...
     * 控制人物 */
    Type2_Mai_AI.prototype.squat = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
        this.statusClear();
    ...
    Type2_Mai_AI.prototype.attack = function () {
        this.attack_start();
    };
    Type2_Mai_AI.prototype.wait = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
        this.checkWait();
     ...
     * 站起后立即进攻
     */
    Type2_Mai_AI.prototype.waitStand = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
    ...
    Type2_Mai_AI.prototype.render_waitStand = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    Type2_Mai_AI.prototype.walk_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.walk_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.dash_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.dash_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.hold = function () {
        return this.hold_u();
    };
    Type2_Mai_AI.prototype.hold_u = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.hold_d = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.jump_f = function () {
        if (this.status_2 != "land") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.jump_b = function () {
        if (this.status_2 != "land") {
            return false;
        }
        this.render_bodyMC_action = this.render_jump;
    ...
    Type2_Mai_AI.prototype.jump = function () {
        if (this.status_2 != "land") {
            return false;
        }
        this.render_bodyMC_action = this.render_jump;
    ...
    Type2_Mai_AI.prototype.punch = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    Type2_Mai_AI.prototype.pitch = function () {
        if (!_super.prototype.pitch.call(this)) {
            return this.punch();
        }
        return true;
    };
    Type2_Mai_AI.prototype.kick2 = function () {
        this.mc.gotoAndStop("kick2");
        this.status_1 = "kick2";
        this.status_3 = "attack";
        return true;
    };
    Type2_Mai_AI.prototype.hold_end = function () {
        this.holdFreeze = false;
    };
    Type2_Mai_AI.prototype.selectOne = function (array) {
    ...
    Type2_Mai_AI.prototype.render_jump = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
     ...
     * 否则等待落地
     */
    Type2_Mai_AI.prototype.air_check = function () {
        if (this.getDis() > 350) {
            return undefined;
        }
        var action = undefined;
    ...
    Type2_Mai_AI.prototype.CPU_check = function (act) {
        var _loc3 = Math.floor(Math.random() * 100);
        if (act == "xuanzhuan" && _loc3 < this.attack_s) {
            if (this.onHit && this.opp.status_3 == "hurt") {
                this.skill_now = "sk_tibing0";
            }
            else if (this.onHit) {
                this.skill_now = "sk_huaxing";
            } // end if
        } // end else if
    }; // End of the 
    return Type2_Mai_AI;
}(Type2_Mai_role));
__reflect(Type2_Mai_AI.prototype, "Type2_Mai_AI");
//# sourceMappingURL=Type2_Mai_AI.js.map