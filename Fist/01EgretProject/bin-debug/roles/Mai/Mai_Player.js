...
var Mai_Player = (function (_super) {
    __extends(Mai_Player, _super);
    function Mai_Player() {
    ...
    Mai_Player.prototype.init = function (keybuttons, _mode_key, controltype) {
    ...
    Mai_Player.prototype.setKey = function () {
    ...
    Mai_Player.prototype.skill_code = function () {
        ...
        this.skill_array.push([this._downButton, this._backButton, this._frontButton, this._kickButton]);
    ...
    Mai_Player.prototype.skill_code_easy = function () {
        this.skill_array.push([this._downButton, this._frontButton, this._kickButton]);
        this.skill_mapping.push(["sk_feixiang"]);
        this.skill_array.push([this._downButton, this._frontButton, this._punchButton]);
        this.skill_mapping.push(["sk_bailu"]);
...
__reflect(Mai_Player.prototype, "Mai_Player");
//# sourceMappingURL=Mai_Player.js.map