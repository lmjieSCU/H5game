...
var Kula_Player = (function (_super) {
    __extends(Kula_Player, _super);
    ...
    Kula_Player.prototype.init = function (keybuttons, _mode_key, controltype) {
    ...
    Kula_Player.prototype.setKey = function () {
    ...
    Kula_Player.prototype.skill_code = function () {
    ...
    Kula_Player.prototype.skill_code_easy = function () {
        this.skill_array.push([this._downButton, this._backButton, this._punchButton]);
        this.skill_mapping.push(["sk_bingdian"]);
...
__reflect(Kula_Player.prototype, "Kula_Player");
//# sourceMappingURL=Kula_Player.js.map