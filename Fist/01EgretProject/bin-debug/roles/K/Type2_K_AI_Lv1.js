...
var Type2_K_AI_Lv1 = (function (_super) {
    __extends(Type2_K_AI_Lv1, _super);
    function Type2_K_AI_Lv1() {
    ...
    Type2_K_AI_Lv1.prototype.skill_init = function () {
    ...
    Type2_K_AI_Lv1.prototype.combo_init = function () {
    ...
    Type2_K_AI_Lv1.prototype.cpu_control = function () {
    ...
    Type2_K_AI_Lv1.prototype.checkAction = function () {
        var _loc2;
        if (this.combo_check_land()) {
            return (true);
        }
        else if (this.opp.status_3 == "down") {
            if (this.checkBurst()) {
                return true;
            } // end if
    ...
    return Type2_K_AI_Lv1;
}(Type2_K_AI)); // End of Class
__reflect(Type2_K_AI_Lv1.prototype, "Type2_K_AI_Lv1");
//# sourceMappingURL=Type2_K_AI_Lv1.js.map