...
var K_AI_Lv5 = (function (_super) {
    __extends(K_AI_Lv5, _super);
    function K_AI_Lv5(num) {
        if (num === void 0) { num = 1; }
    ...
    K_AI_Lv5.prototype.skill_init = function () {
        ...
        this.skill_dis[4] = ["sk_dfp", "sk_dbp", "sk_dfk", "sk_dbk", "walk_f", "dash_f", "jump_f"];
        ...
        this.skill2_dis[2] = ["sk_dfk", "sk_dbk", "jump_f"];
        this.skill2_dis[3] = ["sk_dfk", "sk_dbk", "jump_f"];
        this.skill2_dis[4] = ["sk_dfk", "sk_dbk", "dash_f"];
        this.skill2_dis[5] = ["sk_dbk", "dash_f"];
        this.skill2_dis[6] = ["sk_dbk", "dash_f"];
        this.dis_num = this.dis_array.length;
    };
    K_AI_Lv5.prototype.combo_init = function () {
        ...
        this.combo_burst.sk_fdfp2 = ["sk_dbk"];
        this.combo_burst.sk_s3 = ["sk_s1"];
        this.combo_oppOnEgde.sk_s3 = [true];
        ...
        this.combo_1.walk_b = ["punch_l", "kick_l", "jump", "jump_f", "sk_dbk"];
    ...
    K_AI_Lv5.PlanningSwitch = null;
    return K_AI_Lv5;
}(K_AI));
__reflect(K_AI_Lv5.prototype, "K_AI_Lv5");
//# sourceMappingURL=K_AI_lv5.js.map