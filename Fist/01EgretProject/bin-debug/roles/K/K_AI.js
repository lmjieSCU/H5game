...
var K_AI = (function (_super) {
    __extends(K_AI, _super);
    function K_AI() {
    ...
    /**获得和对方的距离 */
    K_AI.prototype.getDis = function () {
     ...
     * 进攻/防御/停滞/普通
     */
    K_AI.prototype.initStage = function () {
        this.initPlus();
        var _loc2_ = 0;
    ...
    /**初始化进攻率、防御率等属性 */
    K_AI.prototype.initPlus = function () {
     ...
     * @3:随机选择
     */
    K_AI.prototype.cpu_control = function () {
    ...
    K_AI.prototype.cpu_control_easily = function () {
        //使用render_delay_action调用cpu_control,同时清空上一过程判断的combo_Delay
        this.render_AI_control = undefined;
        if (this.render_mc_action == this.render_combo_delay) {
            this.render_mc_action = undefined;
    ...
    K_AI.prototype.checkAction_easily = function () {
    ...
    K_AI.prototype.cpu_normal = function () {
        this.initPlus();
        if (this.checkAttack()) {
     ...
     * 防御状态下选出行为action进行执行
     */
    K_AI.prototype.cpu_defend = function () {
        this.initPlus();
    ...
    K_AI.prototype.cpu_attack = function () {
        this.initPlus();
     ...
     */
    K_AI.prototype.checkAction = function () {
        var action = undefined;
     ...
     * 当前状态为防御时放弃防御
     */
    K_AI.prototype.checkDefend = function () {
     ...
     * 进攻未结束且拥有子技能则防御
     */
    K_AI.prototype.isNeedDefend = function () {
    ...
    /**进攻判断*/
    K_AI.prototype.checkAttack = function () {
     ...
     * 等待x帧后进入攻击
     */
    K_AI.prototype.checkWait = function () {
    ...
    K_AI.prototype.render_checkWait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    /**判断是否进入爆发模式 */
    K_AI.prototype.checkBurst = function () {
        if (this.inBurst) {
            return false;
        }
    ...
    K_AI.prototype.skill_select = function () {
        this.skill_list = [];
        this.getDis();
    ...
    K_AI.prototype.action_select = function (object, member) {
        var aimArr = [];
    ...
    /**返回false或行动action */
    K_AI.prototype.super_select = function () {
    ...
    /**返回false或行动action */
    K_AI.prototype.burst_select = function () {
     ...
     * bug:walk_f无坐标移动
     */
    K_AI.prototype.attack_start = function () {
     ...
     * 判断出是蹲防还是站防
     */
    K_AI.prototype.defend_start = function () {
        var action = undefined;
        this.getDis();
    ...
    /**等待_level0添加必防列表 */
    K_AI.prototype.checkMustDefendSkill = function (oppSkill) {
    ...
    K_AI.prototype.actionDefend = function (action) {
        if (this.status_2 != "land") {
            return undefined;
        }
        if (this.status_3 != "normal") {
    ...
    K_AI.prototype.combo_wait = function (status_1) {
    ...
    K_AI.prototype.render_combo_wait = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    K_AI.prototype.combo_check = function () {
     ...
     * 进攻率低于连招率
     */
    K_AI.prototype.combo_check_land = function () {
        var attack_ratio = Math.floor(Math.random() * 500);
     ...
     */
    K_AI.prototype.combo_select = function (comboType) {
    ...
    K_AI.prototype.combo_start = function () {
        if (this.skill_next == undefined) {
            return;
        }
        if (this.delay == 0) {
     ...
     * 很重要
    */
    K_AI.prototype.combo_delay = function () {
    ...
    K_AI.prototype.render_combo_delay = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    K_AI.prototype.start_control = function () {
        this.control = true;
        this.initStage();
    ...
    K_AI.prototype.toStatus_switch = function (action) {
    ...
    K_AI.prototype.toSkill = function (action, cancle) {
     ...
     * 行为2为移动
     */
    K_AI.prototype.move_walkRun = function () {
        this.render_mc_action = undefined;
    ...
    K_AI.prototype.render_move_walkRun = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    K_AI.prototype.move_squat = function () {
    };
    K_AI.prototype.move_hold = function () {
        this.DEBUG_LOG("move_hold");
        // egret.clearInterval(this.delayTimer);
        this.render_bodyMC_action = this.render_move_hold;
        this.render_bodyMC_action_params = [];
    };
    K_AI.prototype.render_move_hold = function () {
    ...
    K_AI.prototype.attack = function () {
        this.attack_start();
    };
    K_AI.prototype.wait = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
        this.checkWait();
     ...
     * 站起后立即进攻
     */
    K_AI.prototype.waitStand = function () {
        this.statusClear();
        this.status_1 = "stand";
        this.mc.gotoAndStop("stand");
    ...
    K_AI.prototype.render_waitStand = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
    ...
    K_AI.prototype.walk_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.walk_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.dash_f = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.dash_b = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.hold = function () {
        return this.hold_u();
    };
    K_AI.prototype.hold_u = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.hold_d = function () {
        if (this.status_2 != "land" || this.status_3 != "normal") {
            return false;
        }
    ...
    K_AI.prototype.jump_f = function () {
        if (this.status_2 != "land") {
            return false;
        }
    ...
    K_AI.prototype.jump_b = function () {
        if (this.status_2 != "land") {
            return false;
        }
        this.render_bodyMC_action = this.render_jump;
    ...
    K_AI.prototype.pitch = function () {
        if (!_super.prototype.pitch.call(this)) {
            return this.punch();
        }
        return true;
    };
    K_AI.prototype.kick2 = function () {
        this.mc.gotoAndStop("kick2");
        this.status_1 = "kick2";
        this.status_3 = "attack";
        return true;
    };
    K_AI.prototype.hold_end = function () {
        this.holdFreeze = false;
    };
    K_AI.prototype.selectOne = function (array) {
    ...
    K_AI.prototype.render_jump = function () {
        if (_level0.inPause) {
            return undefined;
        }
        if (this.inFreeze) {
     ...
     * 否则等待落地
     */
    K_AI.prototype.air_check = function () {
        if (this.getDis() > 350) {
            return undefined;
        }
        var action = undefined;
    ...
    K_AI.prototype.CPU_check = function () {
        if (this.onHit) {
...
__reflect(K_AI.prototype, "K_AI");
//# sourceMappingURL=K_AI.js.map