...
var Type2_Moriya_Player = (function (_super) {
    __extends(Type2_Moriya_Player, _super);
    ...
    Type2_Moriya_Player.prototype.init = function (keybuttons, _mode_key, controltype) {
    ...
    Type2_Moriya_Player.prototype.setKey = function () {
    ...
    Type2_Moriya_Player.prototype.skill_code_easy = function () {
        this.skill_array.push([this._backButton, this._downButton, this._frontButton, this._kickButton]);
        this.skill_mappin.push(["sk_buyue1"]);
        this.skill_array.push([this._backButton, this._downButton, this._frontButton, this._punch_lButton]);
        this.skill_mappin.push(["sk_buyue3"]);
    ...
    return Type2_Moriya_Player;
}(Type2_Moriya_role)); // End of Class
__reflect(Type2_Moriya_Player.prototype, "Type2_Moriya_Player");
//# sourceMappingURL=Type2_Moriya_Player.js.map