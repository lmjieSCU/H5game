...
var EventroleK_skill = (function () {
    function EventroleK_skill() {
    }
    //第二层级
    EventroleK_skill.event = [
    ...
    //第三层级,单帧事件
    EventroleK_skill.singleFrameEvent = {
    ...
    return EventroleK_skill;
}());
__reflect(EventroleK_skill.prototype, "EventroleK_skill");
//# sourceMappingURL=EventroleK_skill.js.map