 ...
 */
var roleK_Skill = (function () {
    // public old_skill_mc_play_frame: number;
    function roleK_Skill(type, ownrole) {
    ...
    // }
    roleK_Skill.prototype.renderMcAnimate = function () {
        EventUtil.checkFrameEvent(this.skill_mc, 'roleK_skill', this.ownrole);
        this.skill_mc.checkFrameEvent();
        EventUtil.checkSingleFrameEvent(this.skill_mc, 'roleK_skill', this.ownrole);
...
__reflect(roleK_Skill.prototype, "roleK_Skill");
