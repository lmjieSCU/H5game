...
var Chunli_a4188 = (function () {
    function Chunli_a4188() {
        this.firstCall = true;
        return;
    }
    Chunli_a4188.getInstance = function (owner, firstCall) {
    ...
    Chunli_a4188.addEventa4188 = function (MC, own_role) {
        var a4188 = Chunli_a4188.getInstance(own_role, false);
        if (!a4188.firstCall) {
            return;
        }
    ...
    Chunli_a4188.prototype.enterFrame = function (own_role) {
        if (_level0.inPause) {
            return undefined;
        }
        var a4188 = Chunli_a4188.getInstance(own_role);
        var _posObj = eval(a4188.posObj).getInstance(own_role); //opp_B
        var hit = own_role.catch_oppPos2(a4188.MC, _posObj.MC, a4188.status_1, a4188.flag, a4188.land, a4188.hurt, a4188.downHit);
        if (hit) {
...
__reflect(Chunli_a4188.prototype, "Chunli_a4188");
//# sourceMappingURL=Chunli_a4188.js.map