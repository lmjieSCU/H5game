...
var EventroleMoriya_skill = (function () {
    function EventroleMoriya_skill() {
    }
    //第二层级
    EventroleMoriya_skill.event = [
    ...
    //第三层级,单帧事件
    EventroleMoriya_skill.singleFrameEvent = {
    ...
    return EventroleMoriya_skill;
}());
__reflect(EventroleMoriya_skill.prototype, "EventroleMoriya_skill");
//# sourceMappingURL=EventroleMoriya_skill.js.map