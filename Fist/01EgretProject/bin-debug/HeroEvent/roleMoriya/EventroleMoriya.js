...
var EventroleMoriya = (function () {
    function EventroleMoriya() {
    }
    //单帧事件的MC均为三级骨骼
    EventroleMoriya.addEventa5118 = function (MC, own_role) {
        // _root.role_mc[sound].start(startPos,loop);
    };
    EventroleMoriya.addEventa3318 = function (MC, own_role) {
        MC.visible = false;
        own_role.bodyName = 'a3318';
        return;
    };
    //第三层级,单帧事件
    EventroleMoriya.singleFrameEvent = {
    ...
    EventroleMoriya.event = [
        ...
        ["s3465", Moriya_jump.addSprite3465],
        ...
        ["s4181", Moriya_sk_s1_s.addSprite4181],
        ["s4183", Moriya_sk_s2.addSprite4183],
        ["s4184", Moriya_sk_s2_s.addSprite4184],
        ["s4195", Moriya_sk_s3.addSprite4195],
        ["s4198", Moriya_sk_s4.addSprite4198],
        ["s4199", Moriya_sk_feng.addSprite4199],
        ["s4200", Moriya_sk_feng_s.addSprite4200],
        ["s4201", Moriya_sk_xue.addSprite4201],
        ["s4203", Moriya_sk_xue_s.addSprite4203],
        ["s4228", Moriya_sk_s_q1.addSprite4228],
        ["s4229", Moriya_sk_s_q2.addSprite4229]
    ];
    return EventroleMoriya;
}());
__reflect(EventroleMoriya.prototype, "EventroleMoriya");
//# sourceMappingURL=EventroleMoriya.js.map