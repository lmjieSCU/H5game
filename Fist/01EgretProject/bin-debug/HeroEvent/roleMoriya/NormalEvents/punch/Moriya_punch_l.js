...
var Moriya_punch_l = (function () {
    function Moriya_punch_l() {
    }
    Moriya_punch_l.addSprite3578 = function (mc, own_role) {
        mc.addFrameScript(mc, [1, Moriya_punch_l.frame1, 2, Moriya_punch_l.frame2, 3, Moriya_punch_l.frame3, 13, Moriya_punch_l.frame13]);
        return;
    };
    Moriya_punch_l.frame1 = function (mc) {
    ...
    Moriya_punch_l.frame2 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Moriya_punch_l.frame3 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Moriya_punch_l.frame13 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    return Moriya_punch_l;
}());
__reflect(Moriya_punch_l.prototype, "Moriya_punch_l");
//# sourceMappingURL=Moriya_punch_l.js.map