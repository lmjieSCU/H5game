...
var Terry_dbdf_p_max = (function () {
    function Terry_dbdf_p_max() {
    }
    Terry_dbdf_p_max.addSprite9238 = function (mc, own_role) {
    ...
    Terry_dbdf_p_max.frame3 = function (mc) {
    ...
    Terry_dbdf_p_max.frame11 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Terry_dbdf_p_max.frame14 = function (mc) {
    ...
    Terry_dbdf_p_max.frame19 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Terry_dbdf_p_max.frame24 = function (mc) {
        var hitcheck = Hero_HitCheck_obj.getInstance(mc);
        hitcheck.obj_Vx = 0;
        hitcheck.obj_Vy = 0;
        hitcheck.obj_level = 0;
    ...
    Terry_dbdf_p_max.frame30 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Terry_dbdf_p_max.frame34 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Terry_dbdf_p_max.frame61 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    return Terry_dbdf_p_max;
}());
__reflect(Terry_dbdf_p_max.prototype, "Terry_dbdf_p_max");
//# sourceMappingURL=Terry_dbdf_p_max.js.map