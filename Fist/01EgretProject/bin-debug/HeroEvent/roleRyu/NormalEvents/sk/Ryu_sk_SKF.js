...
var Ryu_sk_SKF = (function () {
    function Ryu_sk_SKF() {
    }
    Ryu_sk_SKF.addSprite20995 = function (mc, own_role) {
    ...
    Ryu_sk_SKF.frame10 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_SKF.frame14 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_SKF.frame25 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_SKF.frame26 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
...
__reflect(Ryu_sk_SKF.prototype, "Ryu_sk_SKF");
//# sourceMappingURL=Ryu_sk_SKF.js.map