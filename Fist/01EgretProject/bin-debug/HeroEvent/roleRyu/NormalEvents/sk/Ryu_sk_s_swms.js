...
var Ryu_sk_s_swms = (function () {
    function Ryu_sk_s_swms() {
    }
    //public static DownChanged: boolean = false;
    Ryu_sk_s_swms.addSprite20986 = function (mc, own_role) {
    ...
    Ryu_sk_s_swms.frame1 = function (mc) {
    ...
    Ryu_sk_s_swms.frame2 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame4 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
        Ryu_a20761.getInstance(_parentRole).effName = "bgEff_black";
        var a20604 = Ryu_a20604.getInstance(_parentRole);
        a20604.keyArray = [];
        ...
        a20604.releaseFunc = function (mc, _parentRole) {
            _parentRole.bodyMC.gotoAndStop("attack");
        };
        a20604.endFunc = function (mc, _parentRole) {
        };
    };
    Ryu_sk_s_swms.frame43 = function (mc) {
    ...
    Ryu_sk_s_swms.frame49 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame50 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame51 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame85 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame94 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
    ...
    Ryu_sk_s_swms.frame96 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
    ...
    Ryu_sk_s_swms.frame98 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame101 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt1";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame105 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
        hitcheck.hurtAway = "hurt2";
        hitcheck.flag = "s2";
    ...
    Ryu_sk_s_swms.frame109 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
        hitcheck.hurtAway = "hurt2";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame113 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt1";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame118 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame122 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt1";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame125 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
        hitcheck.hurtAway = "hurt1";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame131 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "hurt2";
    ...
    Ryu_sk_s_swms.frame133 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "";
        hitcheck.hurtAway = "hurt3";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame135 = function (mc) {
        var hitcheck = Hero_HitCheck.getInstance(mc);
        hitcheck.hurtBack = "";
        hitcheck.hurtAway = "hurt3";
        hitcheck.flag = 1;
    ...
    Ryu_sk_s_swms.frame146 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame147 = function () {
        //continueHit = false;
    };
    Ryu_sk_s_swms.frame156 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame186 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame187 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Ryu_sk_s_swms.frame201 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    return Ryu_sk_s_swms;
}());
__reflect(Ryu_sk_s_swms.prototype, "Ryu_sk_s_swms");
//# sourceMappingURL=Ryu_sk_s_swms.js.map