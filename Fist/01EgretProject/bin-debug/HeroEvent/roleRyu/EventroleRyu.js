...
var EventroleRyu = (function () {
    function EventroleRyu() {
    }
    //单帧事件的MC均为三级骨骼
    //还没找到Ryu对应的5118
    EventroleRyu.addEventa5118 = function (MC, own_role) {
        // _root.role_mc[sound].start(startPos,loop);
    };
    //碰撞body属性设置，基本上每帧都会调用。
    EventroleRyu.addEventa20163 = function (MC, own_role) {
        MC.visible = false;
        own_role.bodyName = 'a20163';
        return;
    };
    //第三层级,单帧事件
    EventroleRyu.singleFrameEvent = {
...
__reflect(EventroleRyu.prototype, "EventroleRyu");
//# sourceMappingURL=EventroleRyu.js.map