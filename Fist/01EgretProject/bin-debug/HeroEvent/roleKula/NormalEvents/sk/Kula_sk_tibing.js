...
var Kula_sk_tibing = (function () {
    function Kula_sk_tibing() {
    }
    Kula_sk_tibing.addSprite19620 = function (mc, own_role) {
    ...
    Kula_sk_tibing.frame1 = function (mc) {
    ...
    Kula_sk_tibing.frame4 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Kula_sk_tibing.frame14 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Kula_sk_tibing.frame26 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    Kula_sk_tibing.frame44 = function (mc) {
        var _parentRole = EventUtil.getRole_Parent(mc);
        if (_parentRole == null) {
            return;
        }
    ...
    return Kula_sk_tibing;
}());
__reflect(Kula_sk_tibing.prototype, "Kula_sk_tibing");
//# sourceMappingURL=Kula_sk_tibing.js.map