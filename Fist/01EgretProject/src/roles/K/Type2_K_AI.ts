class Type2_K_AI extends Type2_K_role {
    ...
    constructor() {
        ...
        let hero = new zmovie.ZMovieClip(["roleK0_json", "roleK1_json"], RES.getRes("roleK_json"), "root");
        this.addChild(hero);
        this.mc = <zmovie.ZMovieClip>hero.$children[0];//name:role_K
        this.mc.gotoAndStop("begin");
        this.bodyMC = this.mc.getChildMovie("mc");//二级骨骼,已经进入到每一个动作中 name:punch/kick/...
    }
    ...
    public checkAction_easily(): boolean {
