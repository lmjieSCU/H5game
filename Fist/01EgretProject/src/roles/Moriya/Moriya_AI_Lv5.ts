class Moriya_AI_Lv5 extends Moriya_AI
{
    ...
    public combo_init()
    {
        ...
        this.combo_burst.sk_long_m = ["sk_long_d", "sk_yueying_a1", "sk_yueying_c1", "sk_s2"];
        this.combo_burst.sk_long_d = ["sk_long_m", "sk_yueying_a1", "sk_yueying_c1", "sk_s2"];
        ...
        this.combo_burst.sk_s1 = ["sk_s2", "sk_s3", "sk_s4"];
        this.combo_burst.sk_s2 = ["sk_s3", "sk_s4"];
