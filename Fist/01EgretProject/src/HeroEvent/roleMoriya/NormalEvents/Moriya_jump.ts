class Moriya_jump {
    public static addSprite3465(mc: zmovie.ZMovieClip, own_role: Role) {
        mc.addFrameScript(mc, [3, Moriya_jump.frame3, 20, Moriya_jump.frame20, 21, Moriya_jump.frame21, 24, Moriya_jump.frame24, 29, Moriya_jump.frame29, 33, Moriya_jump.frame33, 36, Moriya_jump.frame36, 39, Moriya_jump.frame39, 43, Moriya_jump.frame43, 48, Moriya_jump.frame48, 50, Moriya_jump.frame50, 54, Moriya_jump.frame54, 59, Moriya_jump.frame59]);
        return;
    }
