class Terry_a7156 {
    ...
    public static instance_First: Terry_a7156;
    public static instance_Second: Terry_a7156;

    constructor() {
        return;
    }

    public static getInstance(owner: Role, firstCall: boolean = true): Terry_a7156 {
    ...
    public static addEventa7156(MC: zmovie.ZMovieClip, own_role: Role) {
        let a7156 = Terry_a7156.getInstance(own_role, false);
        if (!a7156.firstCall) {
            return;
        }
    ...
    public enterFrame(own_role: Role) {
        ...
        let a7156 = Terry_a7156.getInstance(own_role);
        let _posObj = eval(a7156.posObj).getInstance(own_role);//opp_B
        let hit = own_role.catch_oppPos2(a7156.MC, _posObj.MC, a7156.status_1, a7156.flag, a7156.land, a7156.hurt, a7156.downHit);
        if (hit) {
