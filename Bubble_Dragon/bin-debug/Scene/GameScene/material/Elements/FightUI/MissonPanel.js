// class MissonLayer extends Scene {
...
//         this.x = 0;
//         this.y = -200;
//         egret.Tween.get(this).to({ "y": UI.WINSIZE_H / 2 }, 1000).wait(1000).to({ "y": -200 }, 1000).call(this.destroy, this);
//         egret.setTimeout(function () { SoundCtrl.I.playmusic("boxmove"); }, this, 1000);
//         return;
//     }
//     public destroy(): void {
