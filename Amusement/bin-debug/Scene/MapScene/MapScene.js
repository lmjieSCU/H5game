...
var MapScene = (function (_super) {
    ...
    MapScene.prototype.init2 = function () {
        var loc3 = 0;
        var loc6 = 0;
        var loc7 = null;
        this.content = new egret.DisplayObjectContainer();
        this.addChild(this.content);
        var pages = Math.ceil(330 / 18); //一页18关
        loc3 = 1;
        while (loc3 <= pages) {
            loc6 = (loc3 - 1) % 4 + 1;
    ...
    MapScene.prototype.show2 = function () {
        var loc1 = null;
        var level = 0;
        ...
        var soon = UI.addPic("soon1_png", true, this.content, UI.WINSIZE_W / 2, -UI.WINSIZE_H * (-1.3 + Math.ceil(330 / 18)));
