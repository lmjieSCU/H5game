...
var FightUI = (function (_super) {
    ...
    FightUI.prototype.initUI = function () {
        ...
        this.fightctrl.levelNum.anchorOffsetX = this.fightctrl.levelNum.width / 2;
        this.fightctrl.levelNum.anchorOffsetY = this.fightctrl.levelNum.height / 2;
        ...
        this.fightctrl.scoreNum.anchorOffsetX = this.fightctrl.scoreNum.width / 2;
        this.fightctrl.scoreNum.anchorOffsetY = this.fightctrl.scoreNum.height / 2;
        ...
        this.fightctrl.timeNum.anchorOffsetX = this.fightctrl.timeNum.width / 2;
        this.fightctrl.timeNum.anchorOffsetY = this.fightctrl.timeNum.height / 2;
    ...
    /**提示界面 */
    FightUI.prototype.ToHelpLayer = function () {
