...
{	
	//英雄的数
	public static UNLOCK_TYPE_FREE :number = 0;
	public static UNLOCK_TYPE_GOLD :number = 1;
	public static UNLOCK_TYPE_DIAMOND :number = 2;
	public static UNLOCK_TYPE_VIDEOS :number = 3;
	public static UNLOCK_TYPE_TASK :number = 4;
	public static UNLOCK_TYPE_PANS :number = 5;
	//
	public static MAX_HEROS :number = 46;
	public static data:any = 
		//序号		名称		名字		骨胳名		speed		jumpPower		heavy		unlockType		unlockNum		unLockType	
[[	1	,"kakashi","卡","kakashi",	10	,	16	,	3	,	0	,	0	],	//0	免费开放
[	2	,"sasuke_xz","佐","sasuke_xz",	12	,	17	,	3	,	0	,	0	],	//1	金币
[	3	,"naruto","鸣1","naruto",	8	,	15	,	3	,	1	,	22500	],	//2	钻石
[	4	,"orihime","姬","orihime",	10	,	16	,	1	,	1	,	15000	],	//3	激励视频
[	5	,"killerbee","拉","killerbee",	11	,	16	,	5	,	3	,	15	],	//4	任务奖励
[	6	,"ichigo","户一","ichigo",	6	,	15	,	3	,	3	,	20	],	//5	转盘
