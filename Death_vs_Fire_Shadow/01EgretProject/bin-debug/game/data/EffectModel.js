...
var EffectModel = (function () {
    ...
    EffectModel.prototype.initlize = function () {
        this._effect = [];
        this.initEffects();
        //this.cacheEffects();
        return;
    }; // end function
    EffectModel.prototype.initEffects = function () {
        this._effect = [];
    ...
    EffectModel.prototype.cacheEffects = function () {
        for (var _loc_1 in this._effect) {
            //this._effect[_loc_1].cacheBitmapData();
        }
        return;
    }; // end function
    EffectModel.prototype.initHitEffect = function () {
    ...
    EffectModel.prototype.initDefenseEffect = function () {
    ...
    EffectModel.prototype.initSpeicalEffect = function () {
    ...
    EffectModel.prototype.getEffect = function (param1) {
        return this._effect[param1];
    }; // end function
    EffectModel.prototype.getHitEffect = function (param1) {
        return this._effect["hit_" + param1];
    }; // end function
    EffectModel.prototype.getDefenseEffect = function (param1) {
        var _loc_2 = this._effect["defense_" + param1];
        return _loc_2 ? (_loc_2) : (this._effect["defense_5"]);
    }; // end function
    EffectModel.prototype.addHitEffect = function (param1, param2, param3) {
        if (param3 === void 0) { param3 = null; }
        var _loc_4 = new EffectVO(param2, param3);
        this._effect["hit_" + param1] = _loc_4;
        return;
    }; // end function
    EffectModel.prototype.addDefenseEffect = function (param1, param2, param3) {
        if (param3 === void 0) { param3 = null; }
        var _loc_4 = new EffectVO(param2, param3);
        this._effect["defense_" + param1] = _loc_4;
        return;
    }; // end function
    Object.defineProperty(EffectModel, "I", {
        get: function () {
            if (!EffectModel._i) {
