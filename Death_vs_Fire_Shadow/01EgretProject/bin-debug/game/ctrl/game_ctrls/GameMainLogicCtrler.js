...
var GameMainLogicCtrler = (function () {
    function GameMainLogicCtrler() {
        this.renderHit = true;
        this._leftSide = 0;
        this._rightSide = 0;
        return;
    } // end function
    GameMainLogicCtrler.prototype.initlize = function (param1, param2, param3) {
    ...
    GameMainLogicCtrler.prototype.setSpeedPlus = function (param1) {
        var _loc_5 = null;
        var _loc_7 = 0;
        var _loc_3 = 0;
        var _loc_2 = null;
    ...
    GameMainLogicCtrler.prototype.destory = function () {
        return;
    }; // end function
    GameMainLogicCtrler.prototype.render = function () {
        this.renderMainLogic();
        return;
    }; // end function
    //遍历teams中的每个对象,进行render,以及body碰撞检测与hit碰撞检测
    GameMainLogicCtrler.prototype.renderMainLogic = function () {
        var _loc_6 = 0;
        var _loc_7 = 0;
        var _loc_4 = 0;
        var _loc_9 = 0;
    ...
    GameMainLogicCtrler.prototype.renderAnimate = function () {
        this._renderAnimate = true;
        return;
    }; // end function
    GameMainLogicCtrler.prototype.getVec = function (param1) {
    ...
    GameMainLogicCtrler.prototype.checkBodyHit = function (param1, param2) {
        this.A = param1;
        this.B = param2;
        if (!this.renderHit) {
            return;
    ...
    GameMainLogicCtrler.prototype.renderGameSprite = function (param1) {
        var _loc_3 = null;
        var _loc_2 = false;
        // try {
    ...
    GameMainLogicCtrler.prototype.checkHit = function (param1, param2) {
        var param1_bodyArea = null;
        var param2_bodyArea = null;
        if (!this.renderHit) {
            return;
        }
        var param1_curhit = param1.getCurrentHits(); //获得P1hitVO数组
        var param2_curhit = param2.getCurrentHits(); //获得P2hitVO数组
        if (param1 instanceof BaseGameSprite && !param1.isAllowBeHit) {
            param1_bodyArea = null;
        }
        else {
            param1_bodyArea = param1.getBodyArea(); //P1的body区域
        }
        if (param2 instanceof BaseGameSprite && !param2.isAllowBeHit) {
    ...
    GameMainLogicCtrler.prototype.getHitObj = function (param1, param2) {
        var _loc_7 = 0;
        var _loc_4 = null;
        var _loc_3 = null;
        var _loc_6 = null;
        ...
        while (_loc_7 < _loc_5) {
            ...
            if (_loc_3 != null) {
                ...
                if (_loc_6 != null) {
                    ...
                    if (_loc_4 && _loc_4.isEmpty() == false) {
    ...
    GameMainLogicCtrler.prototype.renderPause = function () {
        return;
    }; // end function
    return GameMainLogicCtrler;
}());
__reflect(GameMainLogicCtrler.prototype, "GameMainLogicCtrler");
//# sourceMappingURL=GameMainLogicCtrler.js.map